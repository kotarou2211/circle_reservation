 ...
 *
 * POST (JSON) { line_id, display_name, grade_id?, faculty_id? }
 * → { success, message }
 */
...
try {
    $pdo->prepare("
        INSERT INTO registrants (line_user_id, display_name, grade_id, faculty_id, created_at)
        VALUES (?, ?, ?, ?, NOW())
        ON DUPLICATE KEY UPDATE
            display_name = VALUES(display_name),
            grade_id = VALUES(grade_id),
            faculty_id = VALUES(faculty_id)
    ")->execute([$line_id, $display_name, $grade_id, $faculty_id]);
